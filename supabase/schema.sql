...
-- Physical-count adjustment → log + 'adjust' transaction + set stock (atomic).
...
-- Reset every product in a category to 0 (testing / bulk fix) — logs each as
-- an adjustment + 'adjust' transaction. Returns the number of SKUs changed.
